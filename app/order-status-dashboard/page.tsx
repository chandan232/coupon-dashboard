...
import { BarChart, Bar, PieChart, Pie, Cell, XAxis, YAxis, CartesianGrid, Tooltip, Legend, ResponsiveContainer, LineChart, Line, RadialBarChart, RadialBar, PolarAngleAxis } from 'recharts';
    ...
    return (
      <div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900 p-8">
        <div className="max-w-7xl mx-auto">
          <div className="bg-red-500/10 border border-red-500/30 text-red-200 px-6 py-4 rounded-xl backdrop-blur">
      ...
      <div className="max-w-7xl mx-auto relative z-10">
        ...
        <div className="mt-12 text-center text-purple-300/70 text-sm">
          ...
          <div className="mt-4 flex items-center justify-center gap-4">
            <a href="/api/order-status-summary" className="hover:text-purple-300 transition-colors hover:underline">
              📋 Raw JSON API
            </a>
            <span className="text-purple-500/50">•</span>
            <a href="/dashboard" className="hover:text-purple-300 transition-colors hover:underline">
              🎫 Coupon Dashboard
            </a>
          </div>
        </div>
