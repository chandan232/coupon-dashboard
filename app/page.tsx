          ...
          <div className="space-y-6">
            ...
            <div className="grid grid-cols-5 gap-4">
              {(() => {
                ...
                return (
                  <>
                    <div className="khilna-card p-3 rounded-lg bg-white border border-purple-200">
                      <p className="text-[10px] text-slate-700 font-semibold uppercase mb-1">Applied Amount</p>
                      <p className="text-lg font-black text-slate-900">{appliedAmount}</p>
                      <p className="text-[10px] text-slate-700 mt-0.5">Total discount burn</p>
                    </div>
                    <div className="khilna-card p-3 rounded-lg bg-white border border-purple-200">
                      <p className="text-[10px] text-slate-700 font-semibold uppercase mb-1">Applied Orders</p>
                      <p className="text-lg font-black text-slate-900">{appliedOrderCount}</p>
                      <p className="text-[10px] text-slate-700 mt-0.5">Order count</p>
                    </div>
                    <div className="khilna-card p-3 rounded-lg bg-white border border-purple-200">
                      <p className="text-[10px] text-slate-700 font-semibold uppercase mb-1">Order Value</p>
                      <p className="text-lg font-black text-slate-900">{appliedOrderValue}</p>
                      <p className="text-[10px] text-slate-700 mt-0.5">Total revenue</p>
                    </div>
                    <div className="khilna-card p-3 rounded-lg bg-white border border-purple-200">
                      <p className="text-[10px] text-slate-700 font-semibold uppercase mb-1">Avg Order Value</p>
                      <p className="text-lg font-black text-slate-900">{avgOrderValue}</p>
                      <p className="text-[10px] text-slate-700 mt-0.5">Per order</p>
                    </div>
                    <div className="khilna-card p-3 rounded-lg bg-white border border-purple-200">
                      <p className="text-[10px] text-slate-700 font-semibold uppercase mb-1">% Applied</p>
                      <p className="text-lg font-black text-slate-900">{appliedPercentage}</p>
                      <p className="text-[10px] text-slate-700 mt-0.5">Percentage</p>
                    </div>
                    <div className="khilna-card p-3 rounded-lg bg-white border border-purple-200">
                      <p className="text-[10px] text-slate-700 font-semibold uppercase mb-1">Avg Applied Amount</p>
                      ...
                      <p className="text-[10px] text-slate-700 mt-0.5">Per applied order</p>
                    </div>
                  </>
                );
              })()}
